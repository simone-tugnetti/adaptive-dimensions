...
/**
 * Update [LocalStaticAsp] key by the given [WindowWidthSizeClass] `entry`.
 *
...
@Composable
@NonSkippableComposable
fun CompositionLocalProviderStaticAdaptiveSpByWindowWidthSizeClass(
    ...
    CompositionLocalProviderStaticAdaptiveSp(windowWidthSizeClass.adaptiveSp) {
        content()
    }
...
fun CompositionLocalProviderStaticAdaptiveSpByWindowSize(
    ...
    CompositionLocalProviderStaticAdaptiveSp(windowSize.widthAdaptiveSp(resources)) {
        content()
    }
...
fun CompositionLocalProviderStaticAdaptiveSpByWindowDpSize(
    ...
    CompositionLocalProviderStaticAdaptiveSp(windowDpSize.widthAdaptiveSp) {
        content()
    }
...
fun BoxWithConstraintsStaticAdaptiveSp(
    ...
    BoxWithConstraints(
        ...
        CompositionLocalProviderStaticAdaptiveSp(maxWidthAdaptiveSp) {
            content()
        }
...
/**
 * Update [LocalStaticAsp] key by the given `adaptiveSp` and show a specific `composable`
